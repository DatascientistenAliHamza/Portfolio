    ...
    projects: {
      ...
      rows: [
        ...
        },
        {
          ...
          desc: "Power BI reporting for a sports club, connecting to their data through an API and consolidating operational and performance data into dashboards the club's staff relied on day to day. Along the way I found errors in the club's existing dashboard visualizations, traced them back by comparing against the raw data, and reported them, which ended up helping the software vendor fix the issue too.",
          tags: ["Power BI", "API integration", "Data validation", "Sports operations data"],
        },
      ],
      refNote: "Reference available on request",
    ...
    projects: {
      ...
      rows: [
        ...
        },
        {
          ...
          desc: "Power BI-rapportering för en idrottsklubb, med uppkoppling mot deras data via API och sammanställning av drift- och prestationsdata i dashboards som klubbens personal förlitade sig på varje dag. Under arbetets gång hittade jag fel i klubbens befintliga dashboard-visualiseringar, spårade dem genom att jämföra med rådatan, och rapporterade det, vilket även hjälpte leverantören att åtgärda problemet.",
          tags: ["Power BI", "API-integration", "Datavalidering", "Idrottsverksamhetsdata"],
        },
      ],
      refNote: "Referens finns på begäran",

...
const SPARKS = [
  { path: "M0,45 20,40 40,42 60,30 80,33 100,20 120,24 140,15 160,18 180,8 200,12 220,5", color: "var(--amber)" },
  { path: "M0,10 20,15 40,12 60,22 80,18 100,28 120,24 140,35 160,30 180,40 200,36 220,45", color: "#4CE3D6" },
  { path: "M0,20 20,28 40,18 60,25 80,15 100,30 120,22 140,10 160,16 180,9 200,14 220,6", color: "var(--orange)" },
];
